...
function displayPics(){
  ...
  // Using const is not globally scoped, so when the console.log asks for (rando) it can't find it because the variable is in a function which is not globally scoped.
  console.log(viewed);
